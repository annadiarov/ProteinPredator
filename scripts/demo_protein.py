...
class ThreeDMatchDemo(Dataset):
    ...
    def __getitem__(self,item): 
        ...
        # Downsampling - Not needed for proteins
        ...
        # Center and scale the point clouds coordinates together
        src_pcd_len = src_pcd.shape[0]
        all_points = np.concatenate((src_pcd, tgt_pcd), axis=0)
        all_points = scale_coords(center(all_points))
        src_pcd = all_points[:src_pcd_len]
        tgt_pcd = all_points[src_pcd_len:]
